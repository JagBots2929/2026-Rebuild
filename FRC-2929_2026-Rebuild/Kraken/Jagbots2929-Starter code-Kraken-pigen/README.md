...
- **4x Swerve Modules** (Level 3 configuration)
  - Drive Motors: **Kraken X60** (CAN IDs 1, 3, 5, 7)
  - Turning Motors: **Kraken X60** (CAN IDs 2, 4, 6, 8)
  - Absolute Encoders: CANcoders (CAN IDs 9, 10, 11, 12)
- **Gyro**: **Pigeon 2.0** (CAN ID 20)

### Game Piece Systems
- **Intake Motor**: NEO Brushless (CAN ID 13)
- **Indexer Motor**: NEO Brushless (CAN ID 14)
- **Shooter Motor**: NEO Brushless (CAN ID 15) with flywheel
...
3. Install vendor dependencies:
   - CTRE Phoenix 6 (for Kraken X60 motors, CANcoders, and Pigeon 2.0)
   - REVLib (for NEO motors on intake, indexer, and shooter)
   - Limelight libraries
