...
- **4-Module Swerve Drive** (Level 3 gear ratio)
- **3 Game Piece Systems**: Intake, Indexer, Shooter
...
### Motors (15 total):
- 8x NEO motors (swerve drive & turn)
- 1x NEO motor (intake)
- 1x NEO motor (indexer)
- 1x NEO motor (shooter)

### Sensors:
- 4x CANcoder (swerve absolute encoders)
- 1x NavX gyro (SPI connection)
